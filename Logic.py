...
# region совмещение кругового шума и обычного
...
print(island_world_grad)

# тут была еще одна библиотека, которая конвертировала весь этот массив в картинку
# но когда я засунул код в проект на другом компе, все полетело, так что пока так